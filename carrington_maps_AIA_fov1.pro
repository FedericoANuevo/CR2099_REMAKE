...
; DEMT file and suffix for figs file-name
 file ='LDEM.CR2099_aia_Hollow_3Bands_fov1_gauss1_lin_Norm-median_singlStart'  & suffix = 'CR2099_AIA_3Bands_fov1'
...
; Make the lat-lon maps for N_e, T_m, and Score R with x-tools routines
  xdisplay,map=Nesat,file='Ne_'+suffix,nr=nr,nt=nth,rmin=1.0,rmax=1.2,r0A=r0A,win=0, clrtbl= 25,$
           titulo='Ne [10!U8!Ncm!U-3!N]', units=1.e8, minA=minA_Ne, maxA=maxA_Ne, /add_bw
  xdisplay,map=tmsat,file='Tm_'+suffix,nr=nr,nt=nth,rmin=1.0,rmax=1.2,r0A=r0A,win=0, clrtbl= 25,$
           titulo='Tm [MK]',units=1.e6, minA=minA_Te, maxA=maxA_Te, /add_bw
  xdisplay,map=Rsat, file='R_' +suffix,nr=nr,nt=nth,rmin=1.0,rmax=1.2,r0A=r0A,win=0, clrtbl= 12,$
