...
; DEMT file and suffix for figs file-name
  file ='LDEM.CR2099_aia_Hollow_3Bands_Irmax1.2_gauss1_lin_Norm-median_singlStart'  & suffix = 'CR2099_AIA_3Bands_Irmax1.2' 
; Grid parameters
  rmin = 1.0 & rmax= 1.25 & Irmin = 1.02 & Irmax = 1.2
